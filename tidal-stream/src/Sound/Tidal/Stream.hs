...
import           Sound.Tidal.Value
             ...
             -- (Event, Signal, Span, State (State),
             --                              Time, Valuable,
             --                              Value (VB, VF, VI, VList, VN, VR, VS, VSignal, VState, VX),
             --                              ValueMap, _early, eventMetadata, getF,
             --                              metaSrcPos, sControls, sSpan, silence,
             --                              stack, tidal_status_string,
             --                              tidal_version, value, (!!!))
